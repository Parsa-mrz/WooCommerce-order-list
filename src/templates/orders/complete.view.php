...
foreach ($completed_orders as $order) {
    $order_number = $order->get_order_number(); // Get order number
    $order_date = $order->get_date_created(); // Get order date
    $order_total = $order->get_total(); // Get order total price

    // Output order information
    echo 'Order Number: ' . $order_number . '<br>';
    echo 'Order Date: ' . $order_date->format('Y-m-d H:i:s') . '<br>';
